...
Two monitors consume this: :class:`orchestr_ant_ion.monitoring.system.SystemMonitor`
(a time-series logger with start/record/summary) and
:class:`orchestr_ant_ion.pipeline.monitoring.system.SystemMonitor` (a live
...
if TYPE_CHECKING:
    from orchestr_ant_ion.monitoring.gpu import GPUProbe, GPUSnapshot
